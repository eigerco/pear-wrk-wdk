...
export type MovementWalletConfig = import("@wdk/wallet-movement").MovementWalletConfig;
...
export type Seeds = {
    ...
    solana: Seed;
    /**
     * - The movement's wallet seed phrase.
     */
    movement: Seed;
};
export type WdkConfig = {
    ...
    /**
     * - The movement blockchain configuration.
     */
    movement: MovementWalletConfig;
};
